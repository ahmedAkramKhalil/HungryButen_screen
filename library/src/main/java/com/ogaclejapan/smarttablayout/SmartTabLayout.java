...
//  private ViewPager viewPager;
  ...
  public void scaleView(View v, float startScale, float endScale) {
    Animation anim = new ScaleAnimation(
            ...
            Animation.ZORDER_TOP, 0.5f, // Pivot point of X scaling
            Animation.ZORDER_TOP, 2f); // Pivot point of Y scaling
...
//      viewPager.addOnPageChangeListener(new InternalViewPagerListener());
  ...
  private void scrollToTab(int tabIndex, float positionOffset) {
    ...
    if (tabStrip.isIndicatorAlwaysInCenter()) {
      Log.d("TABLAY","isIndicatorAlwaysInCenter");
    ...
    if (titleOffset == TITLE_OFFSET_AUTO_CENTER) {
      Log.d("TABLAY","TITLE_OFFSET_AUTO_CENTER");
    ...
    if (isLayoutRtl) {
      ...
      x += start - startMargin + extraOffset*10;
    }
  ...
  public interface TabProvider {
     ...
     */
    View createTabView(ViewGroup container, int position, FragmentStateAdapter adapter);
  ...
  private static class SimpleTabProvider implements TabProvider {
    ...
    public View createTabView(ViewGroup container, int position, FragmentStateAdapter adapter) {
      ...
      if (tabTitleView != null) {
        tabTitleView.setText(adapter.getItemCount()+"");
      }
  ...
  private class InternalViewPagerListener extends ViewPager2.OnPageChangeCallback {
    ...
    public void onPageSelected(int position) {
      ...
      //TODO: change Animation
        if (position == i){
          scaleView(tabStrip.getChildAt(i),1f,1.05f);
        }else {
          scaleView(tabStrip.getChildAt(i),1f,1f);
        }
      }
